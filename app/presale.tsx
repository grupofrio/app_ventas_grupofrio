...
const styles = StyleSheet.create({
  ...
  warnTitle: { ...typography.bodySmall, fontWeight: '700', marginBottom: 4 },
  ...
  selectedName: { ...typography.body, fontWeight: '700', marginBottom: 4 },
  changeLink: { ...typography.bodySmall, color: colors.primary, fontWeight: '700' },
  addLink: { ...typography.body, color: colors.primary, fontWeight: '700' },
  ...
  cartName: { ...typography.bodySmall, fontWeight: '600' },
  ...
  totalLabel: { ...typography.bodySmall, fontWeight: '700' },
  ...
  manualToggle: { ...typography.dim, color: colors.primary, fontWeight: '700', marginTop: 10 },
