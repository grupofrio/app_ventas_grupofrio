...
const styles = StyleSheet.create({
  ...
  totalsValue: { ...typography.scoreValue, fontWeight: '800' },
  ...
  progressText: { ...typography.dimSmall, textAlign: 'center', marginBottom: 14 },
  pendingCard: {
    backgroundColor: colors.card,
    borderRadius: radii.card,
    padding: 14,
  ...
  pendingTitle: { ...typography.sectionTitle },
  pendingAmount: {
  ...
  sectionTitle: { ...typography.sectionTitle, marginTop: 16, marginBottom: 8 },
  emptyCard: {
  ...
  orderName: { ...typography.body, fontFamily: fonts.bodyBold, fontWeight: '700' },
  orderAmount: { ...typography.body, color: colors.success, fontFamily: fonts.monoBold },
  orderMeta: {
    ...typography.dim,
    marginTop: 4,
  },
  ...
  typeChipText: { ...typography.dimSmall, color: colors.primary, fontFamily: fonts.bodyBold, fontWeight: '700' },
  statusBadge: {
  ...
  statusBadgeText: { ...typography.dimSmall, fontFamily: fonts.bodyBold, fontWeight: '700' },
  orderError: {
    ...typography.dimSmall,
    color: colors.error,
    marginTop: 6,
