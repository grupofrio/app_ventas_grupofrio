...
const styles = StyleSheet.create({
  ...
  syncIcon: { ...typography.stepperGlyph, fontWeight: '400' },
  syncTitle: { ...typography.cardHeading, flex: 1 },
  syncBody: {
    ...typography.dim,
    lineHeight: 17,
    marginBottom: 8,
  ...
  summaryLabel: { ...typography.body, color: colors.textDim },
  ...
  differenceHint: { ...typography.dimSmall },
  subsectionTitle: {
  ...
  primaryActionText: { ...typography.button, fontWeight: '800' },
  secondaryAction: {
  ...
  secondaryActionText: { ...typography.button, color: colors.primary, fontWeight: '800' },
  actionDisabled: {
    opacity: 0.45,
  },
  blockReasonText: {
  ...
  infoBanner: {
    ...
    backgroundColor: colors.primaryAlpha08,
    borderWidth: 1,
    borderColor: 'rgba(0,119,187,0.2)',
    borderRadius: radii.button,
    padding: spacing.md,
    marginBottom: spacing.lg,
    gap: 8,
  ...
  statusText: { ...typography.bodySmall, color: colors.textDim },
  statusSubText: {
    ...typography.dimSmall,
    textAlign: 'center',
    marginBottom: spacing.sm,
