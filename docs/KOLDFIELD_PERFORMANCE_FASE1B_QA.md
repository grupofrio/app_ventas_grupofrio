...
## Pruebas manuales
- [ ] **App con red lenta:** abrir Home/Ruta no cuelga 45 s en lecturas; cae a ~30 s y usa caché.
- [ ] **ProductPicker sin red:** abre con precios de la jornada (Fase 1A) y NO espera 45 s (lecturas a 30 s).
...
- Timeout de lecturas a 30 s: en redes muy lentas (no muertas) una lectura legítima >30 s fallará y usará caché; aceptable para gama baja.
